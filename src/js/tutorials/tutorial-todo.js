...
const TUTORIAL_TODO = {
    ...
    steps: [
        ...
        },
        {
            ...
            body: 'Targets are added to the To Do List from the <strong>Target Selection</strong> view. After selecting a target and opening the Detail panel, click <strong>Add to To Do List</strong>. The button toggles — click it again to remove the target from the list.',
            target: null,
            position: 'center',
            waitFor: 'next',
            highlight: false
        ...
        },
        {
            ...
            body: 'Here targets are grouped by their best calendar month for imaging from your current location.<br><br>Use this view for long-range planning — for example, identifying which targets you should prioritize over the next few months before they become less favorable.<br><br>Targets without Best Month data appear in a <em>Not Observable</em> group at the bottom.',
        ...
        },
        {
            ...
            body: 'In Rise Time mode a <strong>Chart</strong> button appears. The chart displays all observable targets as a timeline across the night, making it easy to see overlapping visibility windows and sequence your targets efficiently. Toggle back with <strong>List</strong>.',
            target: '.btn-toggle-chart',
            position: 'bottom',
            waitFor: 'next',
            highlight: true
        },

...
const TUTORIAL_TARGET_FILTERING = {
    ...
    steps: [
        ...
        },
        {
            ...
            body: 'Although normally the results update dynamically as you change filter values, you can also click <strong>Apply Filters</strong> to update the results.',

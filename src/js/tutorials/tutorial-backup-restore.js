...
const TUTORIAL_BACKUP_RESTORE = {
    ...
    steps: [
        ...
        },
        {
            ...
            body: 'All user data stores are now checked and the Target Database is disabled. You can uncheck individual items if you only want a partial backup — for example, just your imaging projects and sessions, or perhaps to send your set of Locations to a friend.<br><br>The filename updates automatically to reflect your selection: all boxes checked shows <em>userdata</em>, a single box checked shows the store name, and a partial selection shows <em>partial-userdata</em>.',
            target: '#modal-body',
            position: 'top',
            width: '440px',
            waitFor: 'next',

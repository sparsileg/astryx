...
const TUTORIAL_SEQUENCE_PLANNER = {
    ...
    steps: [
        ...
        // --- Introduction ---
        {
            ...
            type: 'modal',
            title: 'Sequence Planner',
            body: 'This tutorial walks you through the Sequence Planner — the tool that turns your list of pinned targets into a concrete imaging schedule for a specific night.<br><br>It calculates when each target is visible, divides the available imaging time among them, accounts for autofocus runs and meridian flips, and produces a timeline and written plan you can take to the telescope. It takes about 10 minutes.',
            target: null,
            position: 'center',
            waitFor: 'next',
            highlight: false
        ...
        },
        {
            ...
            type: 'callout',
            title: 'Autofocus',
            body: 'When enabled, the planner schedules periodic autofocus runs throughout the session. Autofocus is always assumed at the start of each new target and after a meridian flip regardless of this setting. Disable this option if you don\'t wish to use autofocus timing.<br><br><strong>AF Interval</strong> — the interval between autofocus events in minutes<br><br><strong>AF Duration</strong> — how many minutes each autofocus routine takes. This time is subtracted from imaging time.',
        ...
        },
        {
            id: 'calibration',
            type: 'callout',
            title: 'Calibration and Between Subs',
            body: '<strong>Calibration</strong> — The duration in minutes for guiding calibration before each target\'s imaging sequence and after each meridian flip.<br><br><strong>Between Subs</strong> — the gap in seconds between consecutive exposures, accounting for download time and dithering recovery. For modern cameras and fast USB connections this is typically 6–12 seconds.',
        ...
        },
        {
            ...
            body: 'The Target Allocation card appears after the plan is generated. It shows one row per pinned target and lets you control how imaging time is divided among them.',

...
const TUTORIAL_DAILY_VISIBILITY = {
    ...
    steps: [
        ...
        // --- Date controls ---
        {
            ...
            body: 'This field sets the date for the analysis. Change it to any date you are planning to image. All calculations — twilight times, target rise and set, moon position — update immediately.',
            target: '#dv-date',
            position: 'bottom',
            waitFor: 'next',
            highlight: true
        ...
        },
        {
            ...
            body: 'The background colour tells you the sky state at each point in time: <strong>white</strong> is daylight, <strong>gray</strong> is civil and nautical twilight or indicates moonlight, <strong>dark grey/black</strong> is astronomical darkness.',
        ...
        },
        {
            ...
            body: 'The three narrow bands at the top of the timeline show a cloud cover forecast for today and tomorrow. The top band is high cloud, the middle is mid-level cloud, and the bottom is low cloud.<br><br>Each band uses an amber colour scale — black means clear skies, bright amber means fully overcast. The forecast is only available for today and tomorrow; other dates will show an unavailable message.',
        ...
        },
        {
            ...
            type: 'callout',
            title: 'Moon Card',
            body: 'Shows the moon phase name, illumination percentage, and rise and set times for the night. A bright, well-placed moon is one of the most common reasons to postpone an imaging session — this card, along with the timeline, lets you assess that at a glance.',
